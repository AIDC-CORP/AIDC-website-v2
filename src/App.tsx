...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    brand_message_title:
      "Practice builds intelligence – Intelligence shapes the future.",
  ...
  vn: {
    ...
    map_company_desc:
      "Chuyên cung cấp giải pháp AI và chuyển đổi số toàn diện, từ phát triển phần mềm đến triển khai công nghệ tiên tiến.",
    ...
    philosophy_desc:
      "Mọi sản phẩm của AIDC Corp. phải mang giá trị thực, được kiểm chứng bằng kết quả, và liên tục được hoàn thiện qua học hỏi và sáng tạo.",
    brand_message_label: "Thông điệp thương hiệu",
    brand_message_title:
      "Thực tiễn tạo nên trí tuệ – Trí tuệ kiến tạo tương lai.",
    brand_message_english: "(Practical Intelligence for a Smarter Future)",
    mission_label: "Sứ mệnh",
    mission_content:
      "Kiến tạo các giải pháp trí tuệ nhân tạo và chuyển đổi số mang tính thực tiễn, giúp doanh nghiệp và xã hội phát triển bền vững thông qua sáng tạo, trách nhiệm và chất lượng.",
    vision_label: "Tầm nhìn",
    vision_content:
      "Trở thành doanh nghiệp tiên phong về trí tuệ nhân tạo và chuyển đổi số tại Việt Nam, vươn tầm khu vực – nơi công nghệ được ứng dụng thực tiễn để kiến tạo giá trị cho con người và xã hội.",
    brand_spirit_label: "Tinh thần thương hiệu",
    brand_spirit_content:
      "Dám nghĩ dám làm, hành động có kỷ luật, lấy khách hàng làm trung tâm, không ngừng học hỏi để đi xa hơn.",
